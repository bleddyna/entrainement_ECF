...
function useTransition() {
  let navigation = reactRouterDom.useNavigation();
  React__namespace.useEffect(() => {
    warnings.warnOnce(false, "⚠️ DEPRECATED: The `useTransition` hook has been deprecated in favor of " + "`useNavigation` and will be removed in Remix v2.  Please update your " + "code to leverage `useNavigation`.\n\nSee https://remix.run/docs/hooks/use-transition " + "and https://remix.run/docs/hooks/use-navigation for more information.");
  }, []);
